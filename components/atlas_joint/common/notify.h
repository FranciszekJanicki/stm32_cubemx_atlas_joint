...
typedef enum {
    ...
    SYSTEM_NOTIFY_SAFETY_READY = (1 << 3),
    SYSTEM_NOTIFY_ALL = (SYSTEM_NOTIFY_JOINTS_READY | SYSTEM_NOTIFY_PACKET_READY |
                         SYSTEM_NOTIFY_RETRY_TIMER | SYSTEM_NOTIFY_SAFETY_READY),
} system_notify_t;

typedef enum {
    SAFETY_NOTIFY_RELAY_TRIGGERED = (1 << 0),
    SAFETY_NOTIFY_ALL = (SAFETY_NOTIFY_RELAY_TRIGGERED),
} safety_notify_t;
