...
int main(void)
{
    ...
    atlas_joint_config_t config = {
        .uart_task_ctx = {.uart = &huart2},
        .packet_task_ctx = {.config = {.hmi_packet_ready_gpio = GPIOA,
                                       .hmi_packet_ready_pin = GPIO_PIN_0,
                                       .packet_spi = &hspi1}},
        .joint_task_ctx = {.config = {.delta_timer = &htim2},
                           .joint_task_ctxs = {[ATLAS_JOINT_NUM_1] = {
                                                   .config = {.drv8825_pwm_timer = &htim1,
                                                              .drv8825_pwm_channel = TIM_CHANNEL_4,
                                                              .drv8825_gpio = GPIOA,
                                                              .drv8825_dir_pin = GPIO_PIN_10,
                                                              .ina226_i2c_bus = &hi2c1,
                                                              .ina226_i2c_address = 0x00,
                                                              .as5600_.as5600_gpio = GPIOA,
                                                              .as5600_dir_pin = 0x00,
                                                              .ina226_i2c_address = 0x00},
